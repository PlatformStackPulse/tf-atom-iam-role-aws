...
[![Terraform Format](https://img.shields.io/badge/terraform-fmt-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-atom-iam-role-aws/actions)
[![Terraform Validate](https://img.shields.io/badge/terraform-validate-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-atom-iam-role-aws/actions)
[![TFLint](https://img.shields.io/badge/tflint-passing-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-atom-iam-role-aws/actions)
[![Terraform Test](https://img.shields.io/badge/tests-2%20passed-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-atom-iam-role-aws/actions)
[![Security Scan](https://img.shields.io/badge/trivy-passing-brightgreen?logo=aqua)](https://github.com/PlatformStackPulse/tf-atom-iam-role-aws/actions)
...
[![Documentation](https://img.shields.io/badge/docs-terraform--docs-blue?logo=readthedocs)](https://github.com/PlatformStackPulse/tf-atom-iam-role-aws/actions)
...
Creates a single AWS IAM role with a trust (assume role) policy. The fundamental identity building block for all AWS service integrations.
...
|----------|-------------|
| IAM role creation | Policy documents (→ `tf-atom-iam-policy-aws`) |
| Trust/assume role policy | Policy attachments (→ `tf-atom-iam-role-policy-attachment-aws`) |
| Session duration config | Inline policies (→ `tf-atom-iam-role-policy-aws`) |
| Tags and context | Instance profiles (→ `tf-atom-iam-instance-profile-aws`) |

## Features

- **Single resource** — creates exactly one `aws_iam_role`
- **Context propagation** — inherits naming and tags from tf-label
- **Conditional creation** — disable with `enabled = false`
- **Composable** — designed to be the core of service-role molecules
- **Validated inputs** — JSON trust policy validation
...
```hcl
module "lambda_role" {
  source = "git::https://github.com/PlatformStackPulse/tf-atom-iam-role-aws.git?ref=v1.0.0"
...
| Atom | Relationship |
|------|-------------|
| [`tf-atom-iam-policy-aws`](https://github.com/PlatformStackPulse/tf-atom-iam-policy-aws) | Policy to attach to this role |
...
| [`tf-atom-iam-instance-profile-aws`](https://github.com/PlatformStackPulse/tf-atom-iam-instance-profile-aws) | Wraps role for EC2 |
